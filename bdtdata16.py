...
class BdtData16(object):
    ...
    def __init__(self, filePath):
        self.path = filePath    
        self.propertyKeys = ['PARTICLE-TYPE', 'NOMINAL-ENERGY', 'PRIMARY-PHOTONS', 'PRIMARY-SIGMA', 'SCATTER-DIST', 'SCATTER-SIGMA', 'NORM-VALUE', 
                             'GY/MU-DMAX', 'ENERGY-MIN', 'ENERGY-MAX', 'B-VALUE', 'CHARGED-PARTICLES', 'CHARGED-DIST', 'CHARGED-RADIUS', 
                             'CHARGED-E-MEAN', 'CHARGED-E-MAX', 'PRIMARY-HORN0', 'PRIMARY-HORN1', 'PRIMARY-HORN2', 'PRIMARY-HORN3', 
                             'PRIMARY-HORN4', 'BIN1-START', 'BIN1-WEIGHT', 'BIN-SEC-WEIGHT', 'SEC-B-VALUE', 'SEC-DELTA-B', 'A-VALUE', 
                             'Z-VALUE', 'DELTA-B-OAS', 'BRIM-SCATTER-SIGMA', 'MAX-FIELD-RADIUS', 'EFLUENCE-SLOPE', 'OAS-UNIT', 'COMMONSCOREPLANE', 
                             'CHARGED-FOCUS']
